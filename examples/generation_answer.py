...
class HiggsAudioModelClient:
    def __init__(
        ...
        self._collator = HiggsAudioSampleCollator(
            ...
            encode_whisper_embed=True, #self._config.encode_whisper_embed,
            pad_token_id=self._config.pad_token_id,
            return_audio_in_tokens=self._config.encode_audio_in_tokens,
            use_delay_pattern=True, #self._config.use_delay_pattern
            round_to=1,
    ...
    def _load_audio_waveform(self, audio_path: str) -> Tuple[torch.Tensor, int]:
        try:
            ...
            return waveform.squeeze(0), 24000
    ...
    def generate(
        ...
        **kwargs,
        ...
        for idx, chunk_text in tqdm.tqdm(
            ...
            waveform, sr = self._load_audio_waveform(messages[1].content.audio_url)
        ...
        print(concat_audio_out_ids.shape)
...
def prepare_generation_context(scene_prompt, question_audio, ref_audio, ref_audio_in_system_message, audio_tokenizer, speaker_tags):
    ...
    if ref_audio is not None:
        ...
        if len(speaker_tags) > 1:
            ...
            system_message_l = ["Answer the question in the audio."]
            if scene_prompt:
    ...
    if system_message:
        ...
        audio_tokens = audio_tokenizer.encode(question_audio)
        audio_ids.append(audio_tokens)
